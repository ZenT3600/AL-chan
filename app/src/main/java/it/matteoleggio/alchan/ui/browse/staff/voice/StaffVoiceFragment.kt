...
import it.matteoleggio.alchan.helper.pojo.StaffCharacterMedia
...
class StaffVoiceFragment : BaseFragment() {
    ...
    private fun assignAdapter() {
        adapter = StaffVoiceRvAdapter(requireActivity(), viewModel.staffCharacters, handleStaffVoiceListener)
