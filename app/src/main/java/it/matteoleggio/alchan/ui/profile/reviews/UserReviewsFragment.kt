package it.matteoleggio.alchan.ui.profile.reviews
...
class UserReviewsFragment : BaseFragment() {
    ...
    private fun assignAdapter(): UserReviewsRvAdapter {
        return UserReviewsRvAdapter(requireActivity(), viewModel.userReviews, object : UserReviewsRvAdapter.ReviewsListener {
