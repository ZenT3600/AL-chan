...
class GlobalFeedFilterBottomSheet : BottomSheetDialogFragment() {
    ...
    private fun assignFilterAdapter(): GlobalFeedFilterRvAdapter {
        return GlobalFeedFilterRvAdapter(requireActivity(), viewModel.bestFriends, AndroidUtility.getScreenWidth(activity) / resources.getInteger(R.integer.horizontalListCharacterDivider), object : GlobalFeedFilterRvAdapter.BestFriendListener {
