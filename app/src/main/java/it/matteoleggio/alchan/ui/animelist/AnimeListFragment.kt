package it.matteoleggio.alchan.ui.animelist
...
import it.matteoleggio.alchan.helper.pojo.MediaListTabItem
...
import it.matteoleggio.alchan.ui.animelist.list.*
...
import it.matteoleggio.alchan.ui.common.customise.CustomiseListActivity
    ...
    private fun assignAdapter() {
        adapter = when (viewModel.animeListStyleLiveData.value?.listType ?: ListType.LINEAR) {
            ListType.LINEAR -> {
                ...
                AnimeListRvAdapter(requireActivity(), viewModel.currentList, viewModel.scoreFormat, viewModel.animeListStyleLiveData.value, viewModel.useRelativeDate, handleListAction())
            }
            ListType.GRID -> {
                ...
                AnimeListGridRvAdapter(requireActivity(), viewModel.currentList, viewModel.scoreFormat, viewModel.animeListStyleLiveData.value, viewModel.useRelativeDate, handleListAction())
            }
            ListType.SIMPLIFIED -> {
                animeListRecyclerView.layoutManager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)
                AnimeListSimplifiedRvAdapter(requireActivity(), viewModel.currentList, viewModel.scoreFormat, viewModel.animeListStyleLiveData.value, viewModel.useRelativeDate, handleListAction())
            }
            ListType.ALBUM -> {
                animeListRecyclerView.layoutManager = GridLayoutManager(activity, resources.getInteger(R.integer.gridSpan), GridLayoutManager.VERTICAL, false)
                AnimeListAlbumRvAdapter(requireActivity(), viewModel.currentList, viewModel.scoreFormat, viewModel.animeListStyleLiveData.value, viewModel.useRelativeDate, handleListAction())
            }
        }
