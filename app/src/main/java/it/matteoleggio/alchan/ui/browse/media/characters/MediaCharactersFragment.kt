...
import it.matteoleggio.alchan.helper.pojo.MediaVoiceActors
...
class MediaCharactersFragment : BaseFragment() {
    ...
    private fun assignAdapter(): MediaCharactersRvAdapter {
        return MediaCharactersRvAdapter(requireActivity(), viewModel.mediaCharacters, viewModel.staffLanguage ?: StaffLanguage.JAPANESE, object : MediaCharactersRvAdapter.MediaCharactersListener {
