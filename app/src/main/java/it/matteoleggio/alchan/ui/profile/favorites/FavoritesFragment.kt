...
import it.matteoleggio.alchan.ui.profile.favorites.reorder.ReorderFavoritesActivity
...
class FavoritesFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        favoriteAdapter = FavoritesRvAdapter(requireActivity(), viewModel.getMixedList(), handleListenerAction())
