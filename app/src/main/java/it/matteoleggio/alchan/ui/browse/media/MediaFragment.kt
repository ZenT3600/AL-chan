...
import it.matteoleggio.alchan.ui.browse.media.characters.MediaCharactersFragment
import it.matteoleggio.alchan.ui.mangalist.editor.MangaListEditorActivity
import it.matteoleggio.alchan.ui.browse.media.overview.MediaOverviewFragment
import it.matteoleggio.alchan.ui.browse.media.reviews.MediaReviewsFragment
import it.matteoleggio.alchan.ui.browse.media.social.MediaSocialFragment
import it.matteoleggio.alchan.ui.browse.media.staffs.MediaStaffsFragment
import it.matteoleggio.alchan.ui.browse.media.stats.MediaStatsFragment
        ...
        if (viewModel.mediaType == MediaType.ANIME) {
            if (viewModel.currentMediaData?.episodes != null && viewModel.currentMediaData?.episodes != 0) {
                ...
                mediaTotalCountText.text =
                    "${viewModel.currentMediaData?.episodes} ${getString(R.string.episode).setRegularPlural(
                        viewModel.currentMediaData?.episodes!!
                    )}"
            } else {
            ...
            if (viewModel.currentMediaData?.chapters != null && viewModel.currentMediaData?.chapters != 0) {
                mediaTotalCountDividerIcon.visibility = View.VISIBLE
                mediaTotalCountText.visibility = View.VISIBLE
                mediaTotalCountText.text = "${viewModel.currentMediaData?.chapters} ${getString(R.string.chapter).setRegularPlural(
                    viewModel.currentMediaData?.chapters!!
                )}"
            } else {
                mediaTotalCountDividerIcon.visibility = View.GONE
                mediaTotalCountText.visibility = View.GONE
