...
import it.matteoleggio.alchan.ui.browse.media.stats.MediaStatsStatusRvAdapter
import it.matteoleggio.alchan.ui.browse.user.UserFragment
import it.matteoleggio.alchan.ui.common.ChartDialog
import it.matteoleggio.alchan.ui.profile.stats.details.StatsDetailActivity
...
class StatsFragment : BaseFragment() {
    ...
    private fun handleStatusDistribution() {
        ...
        if (stats.anime?.statuses?.isNullOrEmpty() == false) {
            ...
            animeStatsStatusRecyclerView.adapter = MediaStatsStatusRvAdapter(requireActivity(), animeStatusDistributionList)
        } else {
        ...
        if (stats.manga?.statuses?.isNullOrEmpty() == false) {
            ...
            mangaStatsStatusRecyclerView.adapter = MediaStatsStatusRvAdapter(requireActivity(), mangaStatusDistributionList)
        } else {
